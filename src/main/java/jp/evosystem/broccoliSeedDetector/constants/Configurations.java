...
public interface Configurations {
	 ...
	 * デバッグモードを有効化するかどうか.
	 */
	boolean ENABLE_DEBUG_MODE = true;
	 ...
	 */
	int DEFAULT_CANNY_THRESHOLD_1 = 50;

	/**
	 * Canny処理のしきい値2のデフォルト値.
	 */
	int DEFAULT_CANNY_THRESHOLD_2 = 100;

	/**
	 * 輪郭の面積の最小値のデフォルト値.
	 */
	int DEFAULT_CONTOUR_AREA_MIN_THRESHOLD = 100;

	/**
	 * 輪郭の面積の最大値のデフォルト値.
	 */
	int DEFAULT_CONTOUR_AREA_MAX_THRESHOLD = 1000;
